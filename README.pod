...
=head2 (simo-rect SIMO SIMO X0 Y0 X1 Y1 COLOR-NUM)

=head2 (simo-draw-line SIMO X0 Y0 X1 Y1 COLOR-NUM)

=head2 (simo-to-xpm SIMO)

=head2 (simo-insert SIMO)
